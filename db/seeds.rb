...
seed_data = [
  {
    sentence: 'Apple is looking at buying U.K. startup for $1 billion.', entities: [{ text: 'Apple', type: 'ORG' },
                                                                                    { text: 'U.K.', type: 'GPE' },
                                                                                    { text: '$1 billion',
                                                                                      type: 'MONEY' }]
  }, {
    sentence: 'Regional funds with exposure to United States and outperform equity market over 3 year',
    entities: [{ text: 'Regional funds', type: 'THEME' }, { text: 'United States', type: 'GPE' },
